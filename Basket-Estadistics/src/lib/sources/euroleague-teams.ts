...
export function euroleagueCodeToBrSlug(code: string | undefined): string | undefined {
  if (!code) return undefined
  return EUROLEAGUE_CODE_TO_BR_SLUG[code.toUpperCase()]
}

export function euroleagueTeamLogoUrl(code: string | undefined): string | undefined {
