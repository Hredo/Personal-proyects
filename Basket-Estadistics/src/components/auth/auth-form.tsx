        ...
        <div className="flex flex-1 items-center justify-center px-6 py-10 sm:px-10">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4" noValidate>
              ...
              <div className="relative my-6 flex items-center gap-3 text-[10px] font-mono uppercase tracking-widest text-ink-500">
              ...
              <a
                ...
                className="group flex w-full items-center justify-center gap-3 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm font-semibold text-ink-50 transition hover:border-white/25 hover:bg-white/[0.07]"
              >
...
function GoogleMark({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 48 48" aria-hidden>
      <path
        fill="#FFC107"
        d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.6-6 8-11.3 8-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.1 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.4-.4-3.5z"
      />
      <path
        fill="#FF3D00"
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.1-4 5.6l6.2 5.2C40.7 36.4 44 30.6 44 24c0-1.3-.1-2.4-.4-3.5z"
      />
    </svg>
  )
}
