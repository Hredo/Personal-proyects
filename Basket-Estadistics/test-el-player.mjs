...
async function test() {
  const ids = ["mario-hezonja-1", "luka-doncic-1", "nikola-mirotic-1", "shane-larkin-1", "alperen-sengun-1", "kyle-kurkman-1", "maccabi"];
  for (const id of ids) {
    const res = await fetch(`https://www.basketball-reference.com/international/players/${id}.html`, {
